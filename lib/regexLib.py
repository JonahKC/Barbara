...
M_BLACKLIST = ["M", "𝔪", "𝖒", "Ⓜ", "🅜", "𝓶", "𝓂", "м", "🇲", "🄼", "🅼", "〽", "🄜", "⒨", "Պ", "ṃ", "ḿ", "ṁ", "സ", "൬", "ന", "ണ", "൩", "𝗆", "𝕄", "ꪑ", "ₘ", "ʍ", "ᶆ", "ᗰ", "ᙢ", "ጠ", "爪", "₥", "♍️", "♏️", "Ⓜ️", "〽️", "ℳ", "♏", "♍", "ᛖ", "𝕸", "ꁒ", "ᴹ", "ᵐ", "Ⅿ", "Ｍ", "𝐌", "𝐦", "𝑀", "𝑚", "𝑴", "𝒎", "𝓜", "𝔐", "𝕞", "𝖬", "𝗠", "𝗺", "𝘔", "𝘮", "𝙈", "𝙢", "𝙼", "𝚖", "ϻ", "ɯ", "ɰ", "ɱ", "w", "rn", "01101101", "--", "——", "^^", "∩∩", "/V\\", "/v\\", "/\/\\", "/\/\\", "|\\/|" "|V|", "|v|", "|\\/|", "|\\/|", "l\/l" "lVl", "lvl", "l\\/l", "l\\/l", "I\\/I" "IVI", "IvI", "I\\/I", "I\\/I", "ΛΛ", "⋀⋀", "ᐱᐱ", "𐌡𐌡", "ⴷⴷ", "ʌʌ", "ɅɅ"]
...
, "ȩ", "Ȇ", "ȅ", "Ĕ", "ʓ", "ʒ", "ɜ", "ɝ", "ɚ", "ə", "ɞ", "ʚ", "ⵟ", "𝙴", "01100101", ".", "·", "•", "[̵", "oͤ", "~~[~~", "ᥱ", "乇", "3️⃣", "￡", "💷", "₠", "|Ξ", "|☰", "|Ξ", "|≡", "⁅", "𝛆", "𝛜", "𝜀", "𝜖", "𝜺", "𝝐", "𝝴", "𝞊", "𝞮", "𝟄", "𝚬", "𝛦", "𝜠", "𝝚", "𝞔", "𝛏", "𝜉", "𝝃", "𝝽", "𝞷", "⍷", "ᴇ", "ᴲ", "ᵊ", "ᵋ" "ᵌ", " ͤ", "ɛ", "ɘ", "⅀", "E⃝", "E⃞", "ᶒ", "ᶓ", "ᶔ", "ᶕ", "₤", "♵", "ᶾ", "ᶚ", "ᴣ", "з", "➌", "➂", "❸", "⓷", "㍛", "㋂", "㏢", "₃", "ᶟ", "³", "③", "⒊", "𝟹", "𝟯", "𝟥", "𝟛", "𝟑", "３"]

S_BLACKLIST = [":heavy_dollar_sign:", "ⓢ", "🅢", "$", "𝔰", "𝖘", "Ｓ", "ß", "š", "﹩", "ş", "ṩ", "ṧ", "ṥ", "ṣ", "ṡ", "ഗ", "ട", "⒮", "🇸", "🅂", "𝗌", "5", "𝕤", "Ꮥ", "ѕ", "ડ", "ₛ", "𝓈", "s", "̷", "Տ", "տ", "ȿ", "§", "Ś", "ŝ", "₰", "∫", "ֆ", "క", "𝕾", "ꌚ", "ʂ", "ʃ", "ʅ", "01110011", "...", "···", "•••", "…", "᥉", "丂", "5️⃣", "💲", "₷", "＄", "💰", "🤑", "💵", "💸", "𝑠", "𝒔", "𝓼", "𝘀", "𝘴", "𝙨", "𝚜", "𐒖", "𝐒", "𝑆", "𝒮", "𝓢", "𝔖", "𝕊", "₴", "𝖲", "𝗦", "𝘚", "𝑺", "𝘚", "𝙎", "𝚂", "ᵦ", "ᵝ", "ˢ", "ẞ", "ᶳ", "S⃝", "🄢", "S⃞", "🆂", "ᵴ", "ᴤ", "s̀", "ᶊ", "ᔕ"]
